object Ana: TAna
  ...
  object CHRT: TGR32WGChart
    ...
    Ayarlar.ChartAreaColorAlpha = 192
    ...
    Ayarlar.Axis.Name = 'Droid'
    Ayarlar.Axis.Style = []
    Ayarlar.AxisYCount = 19
    Ayarlar.AxisLineStyle = psDot
    Ayarlar.AxisLineColor = clRed
    Ayarlar.AxisLineColorAlpha = 255
    Ayarlar.AxisLineWidth = 1.000000000000000000
    Ayarlar.AxisTextPos = fpBottomRight
  ...
  object GR32WGChart1: TGR32WGChart
    Left = 286
    Top = 140
    Width = 229
    Height = 151
    ...
    Ayarlar.BackgroundHover = clBlack
